...
var ActivitiesService = function () {
    ...
    var _classThis;
    var ActivitiesService = _classThis = /** @class */ (function () {
        function ActivitiesService_1(prisma) {
            this.prisma = prisma;
        }
        ActivitiesService_1.prototype.findAll = function (userId_1) {
            return __awaiter(this, arguments, void 0, function (userId, limit, offset) {
                var _a, activities, total;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, Promise.all([
                                ...
                                this.prisma.activity.count({ where: { userId: userId } }),
                            ])];
                        case 1:
                            _a = _b.sent(), activities = _a[0], total = _a[1];
                            return [2 /*return*/, { activities: activities, total: total, limit: limit, offset: offset }];
                    }
                });
            });
        };
        return ActivitiesService_1;
    }());
